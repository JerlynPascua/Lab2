...
<body>
      ...
      <div class="row">
        <div class="col-lg-7 align-self-center">
          <div class="caption  header-text">
            ...
            <h4>My list of <em>Resources</em> and <em>Guides</em></h4>
			<p>All rights reserved to the mentioned groups</p>
          </div>
        </div>
        <div class="col-lg-5">
  ...
  <div class="happy-steps">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2><em>Information</em> and <em>preferences!</em></h2>
        </div>
        <div class="col-lg-12">
          <div class="steps">
            <div class="row">
              <div class="col-lg-3">
                <div class="item">
                  <img src="assets/images/heartbase.png" alt="" style="max-width: 66px; border-radius: 50%; margin: 0 auto;">
                  <h4>Recommended web 1</h4>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="item">
                  <img src="assets/images/flowerbase.png" alt="" style="max-width: 66px; border-radius: 50%; margin: 0 auto;">
                  <h4>Recommended web 2</h4>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="item">
                  <img src="assets/images/makeupbase.png" alt="" style="max-width: 66px; border-radius: 50%; margin: 0 auto;">
                  <h4>Recommended web 3</h4>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="item last-item">
                  <img src="assets/images/sunbase.png" alt="" style="max-width: 66px; border-radius: 50%; margin: 0 auto;">
                  <h4>Recommended web 4</h4>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="section-heading">
            <h2>Here are my <em>Resources</em> and <span>Guides</span> in creating my website</h2>
            <div class="line-dec"></div>
            <p>Credits to the creators! </p>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <div class="accordions is-first-expanded">
            <article class="accordion">
              ...
              <div class="accordion-body">
                  <div class="content">
                      <p>SEO company, all rights reserved. Template.IO - <a href="index.html">Home</a>, <a href="about.html">About</a>, and <a href="faqs.html">FAQ</a>.</p>
                  </div>
              </div>
          </article>
          <article class="accordion">
            <div class="accordion-head">
                <span>W3 SCHOOL HTML</span>
                <span class="icon">
                    <i class="icon fa fa-chevron-right"></i>
                </span>
            </div>
            <div class="accordion-body">
                <div class="content">
                    <p>all the included lessons in HTML W3 School Course</p>
                </div>
            </div>
          </article>
          <article class="accordion">
            <div class="accordion-head">
                <span>W3 SCHOOL CSS</span>
                <span class="icon">
                    <i class="icon fa fa-chevron-right"></i>
                </span>
            </div>
            <div class="accordion-body">
                <div class="content">
                    <p>all the included lessons in CSS W3 School Course</p>
                </div>
            </div>
          </article>
          <article class="accordion">
            <div class="accordion-head">
                <span>W3 SCHOOL JAVASCRIPT</span>
                <span class="icon">
                    <i class="icon fa fa-chevron-right"></i>
                </span>
            </div>
            <div class="accordion-body">
                <div class="content">
                  <p>all the included lessons in JS W3 School Course</p>
                </div>
            </div>
          </article>
        </div>
...
?>
  ...
  <div class="cta section">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <h4>Suggestions for website design ?</h4>
        </div>
        <div class="col-lg-4">
  ...
  <footer>
    <div class="container">
      <div class="col-lg-12">
       <p><br>This webpage will serve as an example portfolio for JCPP's Webprog completion</p>
